<template>
  <div class="cover">
    ...
    <main id="main" class="wrapper">
      <h1 class="blog__title">Protonull Blog</h1>
      ...
      <h2 class="category__title">Protonull Life</h2>
        <swiper class="swiper" :options="swiperOption">
            <swiper-slide v-for="post in protonullLifePosts">
                <Post :post=post></Post>
            </swiper-slide>
            <div class="swiper-pagination" slot="pagination"></div>
            <div class="swiper-button-prev" slot="button-prev"></div>
...
export default {
  ...
  computed: {
    ...
    protonullLifePosts() {
      return this.getPostsByCategory("PROTONULL LIFE");
    }
  }
}
</script>
